...
def train_Model(canvas):
    ...
    es_callback = EarlyStopping(monitor='categorical_accuracy', mode='max', patience=100, min_delta=0.01, baseline=0.88)
    mc_callback = ModelCheckpoint('model.h5', monitor='val_categorical_accuracy', mode='max', save_best_only=True)
